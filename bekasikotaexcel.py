# 2. This is the excel output for bekasikota.py
...
def writer(parametr):
    book = xlsxwriter.Workbook(r"C:\Users\organizer\pyproj\my_env\bekasikota.xlsx") # this is to create a new excel, choose the path you wanted to save the file
