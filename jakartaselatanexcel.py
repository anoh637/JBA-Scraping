# 2. This is the excel output for jakartaselatan.py
...
from jakartaselatan import array # 'run' is the name of run.py file, 'array' is the final looping name we wanted to print

def writer(parametr):
    book = xlsxwriter.Workbook(r"C:\Users\organizer\pyproj\my_env\jakartaselatan.xlsx") # this is to create a new excel, choose the path you wanted to save the file
